    ...
    <div class="container mx-auto px-4" id="blog-list">
      <section class="py-8 px-4">
        <div class="max-w-3xl mx-auto">
          ...
          <p class="text-lg">
            This is just a sample of the work I've completed including subject
            matters and technologies I used to build them.
          </p>
        </div>
      </section>
      <div class="flex text-sm justify-around p-10">
        <div>
          Showing page {{ $page.works.pageInfo.currentPage }} of
          {{ $page.works.pageInfo.totalPages }}
        </div>
